...
class ShopifyService:
    ...
    def __init__(self):
        self.connected = bool(shopify_settings.SHOPIFY_SHOP_DOMAIN and shopify_settings.SHOPIFY_ACCESS_TOKEN)
    ...
    async def update_product(self, item: Dict[str, Any], product_id: str) -> Dict[str, Any]:
    ...
    async def _mock_update_product(self, item: Dict[str, Any], product_id: str) -> Dict[str, Any]:
    ...
    async def _mock_delete_product(self, product_id: str) -> Dict[str, Any]:
        ...
        return {
            "success": True,
            "message": "Product successfully removed from Shopify"
        }
    ...
    def _prepare_shopify_data(self, item: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "images": [
                {"src": img} for img in item.get("images", [])
            ]
        } 